...
import 'package:miapp11/pages/pagos_page.dart';
...
class ProgramasWidget extends StatelessWidget {
  final String dni;
  const ProgramasWidget({Key? key, required this.dni}) : super(key: key);
...
class CardWidget extends StatelessWidget {
  ...
  const CardWidget({Key? key, required this.programa}) : super(key: key);
