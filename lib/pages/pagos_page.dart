...
import 'package:miapp11/pages/recaudaciones_page.dart';
import 'package:miapp11/utilities/constants.dart';

class PagosPage extends StatefulWidget {
  final String codigoAlumno;

  const PagosPage({Key? key, required this.codigoAlumno}) : super(key: key);
...
class _PagosPageState extends State<PagosPage>
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget cancelButton = ElevatedButton(
      ...
      onPressed: () => Navigator.pop(context), //color: Colors.indigo,
    );
