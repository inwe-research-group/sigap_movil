...
import 'package:miapp11/pages/tabs/ajustes.dart';
import 'package:miapp11/pages/tabs/perfil.dart';
  ...
  TabBarView getTabBarView() {
    return TabBarView(
      ...
      children: <Widget>[
        ...
        ProgramasWidget(dni: widget.usuario.getDni),
        AjustesWidget()
      ],
    );
  }
